...
type FlexCardProps = ComponentProps & {
  fields: {
    data?: {
      datasource?: FlexCardFields;
    };
  };
};

const Default = (props: FlexCardProps): JSX.Element => {
  ...
  console.log('FlexCard FULL DEBUG:', {
  ...
  if (!datasource) {
    ...
    if (isEditing) {
      return (
        <div className={`component flex-card ${styles || ''}`} id={id}>
          <div className="component-content">
            <div style={{ padding: '20px', background: '#f5f5f5', border: '2px dashed #ccc' }}>
              <h3 style={{ marginTop: 0 }}>Flex Card</h3>
